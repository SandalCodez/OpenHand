...
def send_morning_reminder_email():
    try:
        ...
        users_ref = [
            'KHANA30@FARMINGDALE.EDU',
            'COSTA18@FARMINGDALE.EDU',
            'GULICW@FARMINGDALE.EDU',
            'N00839007@students.ncc.edu',
            'sperd45@mail.sunysuffolk.edu',
            'KARAE31@FARMINGDALE.EDU',
            'SANDEF3@FARMINGDALE.EDU',
            'madhg41@mail.sunysuffolk.edu',
            'AKBAH@FARMINGDALE.EDU',
            'KAZMHA@FARMINGDALE.EDU',
            'COMPI@FARMINGDALE.EDU',
            'DEVAJ5@FARMINGDALE.EDU',
            'PAULJ4@FARMINGDALE.EDU',
            'DEREJ@FARMINGDALE.EDU',
            'CONAKP@FARMINGDALE.EDU',
            'greenwl@farmingdale.edu',
            'PEREMA9@FARMINGDALE.EDU',
            'CATAMV3@FARMINGDALE.EDU',
            'MORAMD1@FARMINGDALE.EDU',
            'N00901115@students.ncc.edu',
            'SORYO@FARMINGDALE.EDU',
            'FERDT4@FARMINGDALE.EDU'
        ]
        for doc in users_ref:
            try:
                msg = create_morning_email(doc)
